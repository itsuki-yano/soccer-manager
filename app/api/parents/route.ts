...
export async function POST(req: Request) {
  try {
    ...
    await appendRow("parents", [id, body.playerName, body.furigana, body.jerseyNumber, body.group, body.carCapacity, body.bucketOrder ?? 0, body.uniformNumber ?? "", body.blueBibsNumber ?? "", body.yellowBibsNumber ?? "", body.blueBibsMemo ?? ""]);
